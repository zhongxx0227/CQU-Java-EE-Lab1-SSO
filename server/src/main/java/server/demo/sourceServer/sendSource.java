...
public class sendSource {
    ...
    public String sendSource(HttpServletRequest request, Model model)
    {
        ...
        String source = "";
        String newToken = "";
        System.out.println("sendSource msg: "+msg);
        if(msg.equals("true"))
        {
            ...
            System.out.println("sendSource username: "+username);
            System.out.println("sendSource sourceType: "+sourceType);
            System.out.println("sendSource source: "+source);
        }
